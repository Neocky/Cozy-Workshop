...
ServerEvents.recipes(event => {
    ...
    event.recipes.create.item_application(['create:andesite_casing'],
        [Ingredient.of([
            'overweight_farming:overweight_potato_block', 'overweight_farming:overweight_apple_block', 'overweight_farming:overweight_beetroot_block', 'overweight_farming:overweight_carrot_block', 'overweight_farming:overweight_cocoa_block', 'overweight_farming:overweight_nether_wart_block', 'overweight_farming:overweight_poisonous_potato_block'
